...
public class ClosestPlayerHUDSwitchMapTargetHudElement {
   ...
   static {
      try {
         ...
         try {
            b[TargetHudElement.HEAD.ordinal()] = 1;
         } catch (NoSuchFieldError var20) {
         }

         try {
            b[TargetHudElement.NAME.ordinal()] = 2;
         } catch (NoSuchFieldError var19) {
         }

         try {
            b[TargetHudElement.HP.ordinal()] = 3;
         } catch (NoSuchFieldError var18) {
         }

         try {
            b[TargetHudElement.HEIGHT.ordinal()] = 4;
         } catch (NoSuchFieldError var17) {
         }

         try {
            b[TargetHudElement.ARROW.ordinal()] = 5;
         } catch (NoSuchFieldError var16) {
         }

         try {
            b[TargetHudElement.TEAM.ordinal()] = (int)var0[1];
         } catch (NoSuchFieldError var15) {
         }

         try {
            b[TargetHudElement.DIST.ordinal()] = (int)var0[0];
